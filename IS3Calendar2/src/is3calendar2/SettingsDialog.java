...
public class SettingsDialog extends javax.swing.JDialog {
    ...
    private void SaveSettingsButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_SaveSettingsButtonMouseClicked
        ...
        try {
            x = Integer.parseInt(LowCountText.getText());
            if (x > 0) {
                MainFrame.lowBusynessCount = x;
            }
        } catch (Exception e) {
        }
        try {
            x = Integer.parseInt(MediumCountText.getText());
            if (x > 0) {
                MainFrame.mediumBusynessCount = x;
            }
        } catch (Exception e) {
        }
        try {
            x = Integer.parseInt(HighCountText.getText());
            if (x > 0) {
                MainFrame.highBusynessCount = x;
            }
        } catch (Exception e) {
        }
