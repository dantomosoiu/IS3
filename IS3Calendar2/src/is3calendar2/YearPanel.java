...
public class YearPanel extends javax.swing.JPanel {
    ...
    private void setupTable() {
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 4; j++) {
                data[i][j] = new YearCell(new int[42], new int[42]);
            }
        }
    ...
    public void populateTable() {
        ...
        for (int j = 0; j < 12; j++) {
            ...
            for (; i < CalendarDate.getDaysOfMonth(j + 1, year) + offset; i++) {
                List<Appointment> appointments = cal.getAppointmentsBetweenDates(new CalendarDate(i - offset + 1, j + 1, year), new CalendarDate(i - offset + 1, j + 1, year));
                if (category != 0) {
                ...
                busy[i] = appointments.size();
                numbers[i] = i - offset + 1;
            }
            for (; i < 42; i++) {
                busy[i] = 0;
                numbers[i] = 0;
