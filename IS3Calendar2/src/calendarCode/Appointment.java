...
public class Appointment implements Comparable<Appointment> {
    ...
    public Appointment(CalendarDate the_date, CalendarTime s_time, CalendarTime e_time, String desc, String loc, int cat) {
        ap_id = 0;
    ...
    public Appointment(CalendarDate the_date, CalendarTime s_time, CalendarTime e_time, String desc, String loc, int cat, Recurrence rec, int rem) {
        ap_id = 0;
    ...
    public int compareTo(Appointment o) {
        if (this.date.year != o.date.year) {
            return this.date.year - o.date.year;
        } else if (this.date.month != o.date.month) {
            return this.date.month - o.date.month;
        } else if (this.date.day != o.date.day) {
            return this.date.day - o.date.day;
        } else if (this.start_time.hr != o.start_time.hr) {
            return this.start_time.hr - o.start_time.hr;
        } else if (this.start_time.min != o.start_time.min) {
            return this.start_time.min - o.start_time.min;
        } else if (this.end_time.hr != o.end_time.hr) {
            return this.end_time.hr - o.end_time.hr;
        } else {
            return this.end_time.min - o.end_time.min;
        }
    }
}
