...
public class YearCell extends javax.swing.JPanel {
    ...
    public YearCell(int[] i, int[] j) {
        ...
        for (int y = 0; y < j.length; y++) {
            ...
            if (i[y] != 0 && i[y] < 5) {labels[y].setOpaque(true);labels[y].setBackground(Color.yellow);}
            else if (i[y] != 0 && i[y] < 10) {labels[y].setOpaque(true);labels[y].setBackground(Color.orange);}
            else if (i[y] > 9) {labels[y].setOpaque(true);labels[y].setBackground(Color.red);}
