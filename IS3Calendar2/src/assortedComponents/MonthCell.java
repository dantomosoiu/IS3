...
public class MonthCell extends javax.swing.JPanel {
    ...
    public MonthCell(int i, int j) {
        initComponents();
        if (i > 0) dayNum.setText(Integer.toString(i));
        else dayNum.setText("");
        this.setBackground(Color.white);
        if (j > 0) numEvents.setText(Integer.toString(j));
        else numEvents.setText("");
        if (j>4) this.setBackground(Color.ORANGE);
        if (j>9) this.setBackground(Color.RED);
    }
